...
def range_calc(lines):
    ...
    for line in lines:
        ...
        if ((int(range1n1) <= int(range2n1) and int(range1n2) >= int(range2n2)) or ((int(range1n1) >= int(range2n1) and int(range1n2) <= int(range2n2)))):
            count += 1

    return count

def overlap_calc(lines):
...
if __name__ == "__main__":
    ...
    print(f'Challenge 2 Answer: {overlap_calc(lines)}')
